...
class Equipamento
{
    protected static $table = 'equipamentos'; // Nome da tabela de clientes
    ...
    {
        return Sql::getAllLikeLimit(self::$table, 'id', $nome); // Acesso correto à propriedade estática
    }

    // Método de instância para listar todas as categorias
    public static function listar()
    {
        return Sql::getEquipamentosAll(); // Acesso correto à propriedade estática
    }

    public static function listarNomeCategoria($nome){
       
            return Sql::buscarEquipamentosPorCategoria($nome); // Acesso correto à propriedade estática
    }
}
